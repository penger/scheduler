...
import com.shsnc.SpoolDirectoryTailFileSourceConfigurationConstants.*;
...
public class ReliableSpoolDirectoryTailFileEventReader implements ReliableEventReader{
	...
	/**
	  ...
	  private boolean isTargetFile(Optional<FileInfo> currentFile2) {
		...
		if(targetFilename.contains("_")) {
			String[] split = targetFilename.split("_");
			SimpleDateFormat dateFormat = new SimpleDateFormat(split[0]);
			String substringOfTargetFile = dateFormat.format(new Date());
			if(inputFilename.toLowerCase().contains(substringOfTargetFile.toLowerCase()+split[1])){
				return true;
			}
		}else {
	...
	public static class Builder {
		...
		private String completedSuffix = SpoolDirectoryTailFileSourceConfigurationConstants.SPOOLED_FILE_SUFFIX;
		private String ignorePattern = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_IGNORE_PAT;
		private String targetPattern = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_TARGET_PAT;
		private String targetFilename = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_TARGET_FILENAME;
		private String trackerDirPath = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_TRACKER_DIR;
		private boolean annotateFileName = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_FILENAME_HEADER;
		private String fileNameHeader = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_FILENAME_HEADER_KEY;
		private boolean annotateBaseName = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_BASENAME_HEADER;
		private String baseNameHeader = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_BASENAME_HEADER_KEY;
		private String deserializerType = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_DESERIALIZER;
		private Context deserializerContext = new Context();
		private String deletePolicy = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_DELETE_POLICY;
		private String inputCharset = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_INPUT_CHARSET;
		private DecodeErrorPolicy decodeErrorPolicy = DecodeErrorPolicy.valueOf(SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_DECODE_ERROR_POLICY.toUpperCase());
		private ConsumeOrder consumeOrder = SpoolDirectoryTailFileSourceConfigurationConstants.DEFAULT_CONSUME_ORDER;
